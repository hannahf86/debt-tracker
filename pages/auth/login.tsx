...
export default function LoginPage() {
  ...
  return (
    <>
      <Seo
        title="Sign in"
        description="Sign in to Mirian to pick up where you left off."
        noindex
      />
      <div className="min-h-screen bg-page-accent flex items-center justify-center p-4">
        <div className="w-full max-w-sm">
          <div className="mb-8 text-center">
            ...
            <p className="text-3xl font-bold text-sage-800 mb-2">Mirian</p>
          ...
          <div className="bg-white border border-mint-200 rounded-2xl p-8 shadow-sm">
            <h1 className="text-xl font-semibold text-sage-800 mb-6">Sign in</h1>
